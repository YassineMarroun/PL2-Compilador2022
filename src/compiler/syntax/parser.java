...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Wed Mar 30 00:15:56 CEST 2022
  */
...
class CUP$parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	syntaxErrorManager.syntaxInfo("�?mbito principal " + nombre + " abierto");
	...
	syntaxErrorManager.syntaxInfo("�?mbito función " + nombre + " cerrado");
	...
	String nombre = id.getLexema().toUpperCase();
	scopeManager.openScope(nombre);
	syntaxErrorManager.syntaxInfo("�?mbito función " + nombre + " abierto");
	...
	scopeManager.closeScope();
	syntaxErrorManager.syntaxInfo("�?mbito procedimiento " + nombre + " cerrado");
	...
	String nombre = id.getLexema().toUpperCase();
	scopeManager.openScope(nombre);
	syntaxErrorManager.syntaxInfo("�?mbito procedimiento " + nombre + " abierto");
