...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Apr 14 20:26:42 CEST 2022
  */
  ...
  public final java_cup.runtime.Symbol CUP$parser$do_action(
	...
	if(tipo != null) {
		...
		if(tipo instanceof TypeProcedure) {
			...
			semanticErrorManager.semanticFatalError("Error semántico: " + nombre + " no es un subprograma");
		}
	} else {
		semanticErrorManager.semanticFatalError("Error semántico: no existe la función " + nombre);
	}
	...
	ScopeIF ambito = scopeManager.getCurrentScope();
	TypeTableIF tiposTabla = ambito.getTypeTable();	TypeIF tipo = tiposTabla.getType("LOGICO");
	Expresion exp = new Expresion(tipo);
	RESULT = exp;
	...
	if(tipo instanceof TypeFunction) {
		...
		semanticErrorManager.semanticFatalError("Error semántico: expresión de llamada a función debe ser una función");
	}
	...
	TypeTableIF tiposTablaPadre = ambito.getTypeTable();
	...
	// Al detectar al id de la función se tiene que abrir el ámbito
	String nombre = id.getLexema().toUpperCase();
	scopeManager.openScope(nombre);
	...
	// No se puede devolver un vector
